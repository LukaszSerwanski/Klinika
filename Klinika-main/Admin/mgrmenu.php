...
<div class="container" style="width:100%;background-image:url(mgrchange.jpg)">
	...
	<form method="post">
	  <button type="button" name="change" onclick="window.location.href='changebookingstatus.php'">Zmień/Zobacz status wizyty</button>
	  <button type="submit" name="logout" style="float:right">Wyloguj</button>
	</form>
    </div>
</div>
<?php
