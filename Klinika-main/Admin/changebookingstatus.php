...
<body style="background-image:url(../images/doctordesk.jpg)">
	<div class="header">
		<ul>
		<li style="float:left;border-right:none"><a href="index.php" class="logo"><img src="cal.png" width="30px" height="30px"><strong> Klinika </strong>Szybko i bezboleśnie</a></li>
			<li><a href="mgrmenu.php">Start</a></li>
		</ul>
	</div>
	...
	<div>
		...
		<label style="font-size:20px"><b>Doktor:</b></label><br>
		...
		<br>
			<button type="submit" style="position:center" name="submit" value="Submit">Sprawdź</button>
			</form>
<?php
...
?>		
			...
			<button type="submit" style="position:center" name="submit2" value="Submit">Zapisz zmiany</button></form>		
<?php
}
require_once("dbconfig.php");
			if(isset($_POST['submit2']))
		{
			...
			{	
				...
				{
							echo "$fnm[$j] :Status zaktualizowany..!!<br>";
			...
			echo "Przekierowanie.....";
			header( "Refresh:2; url=changebookingstatus.php");
