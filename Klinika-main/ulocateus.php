...
<body style="background-image:url(images/p2.jpg)">
	<div class="header">
		...
		<li style="float:left;border-right:none"><a href="ulogin.php" class="logo"><img src="images/cal.png" width="30px" height="30px"><strong> Klinika </strong>Szybko i bezboleśnie</a></li>
			<li><a href="ulogin.php">Start</a></li>
		</ul>
	</div>
	<form action="ulocateus.php" method="post">
	<div class="sucontainer">
		<ul>			
		<label><b>Szukaj doktora</b></label>
			<input type="text" name="doctorname" placeholder="Imię i nazwisko doktora"></input>
			<button type="submit" style="position:center" name="subd" value="Submit">Wyślij</button>
		</ul>
		<label style="font-size:20px" >Powiat:</label><br>
...
if(isset($_POST['submit']))
{
		...
		echo "<label><b>Nazwa Kliniki:  ".$row1['name']."</b><br><b>Adres:  <b>".$row1['address']."<br><b>Kontakt:  <b>".$row1['contact']."<br><b>Imię Doktora:  <b>".$row2['name']."<br><b>Specjalizacja:  <b>".$row2['specialization']."<br><b>Kontakt:  <b>".$row2['contact']."</label>"; 
}
?>
